...
class TestBaseMethod(unittest.TestCase):
    ...
    def test_file_name(self):
        self.assertEqual(self.base_method._file_name,
            self.base_method.file_name,
